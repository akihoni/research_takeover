...
parser.add_argument("--model_path", default="./model/fruity_stat.pkl")
parser.add_argument("--mol_label_path", default="./data/ori_mol_label.csv")
parser.add_argument("--aim_label", default="fruity")
...
mol_label_path = args.mol_label_path
...
# load data
mol_label = pd.read_csv(mol_label_path, usecols=['smiles', aim_label])
smiles = mol_label['smiles']
label = mol_label[aim_label].to_frame()
