...
cd ..
python gen_latent.py --data ./data/smiles_all.txt --vocab ./data/vocab.txt --hidden 450 --depth 3 --latent 56 --model ./data/vae_model/model.iter-6 --save ./data/latent_vector.txt
