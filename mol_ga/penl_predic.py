...
parser.add_argument("--col_name", default="fruity")
parser.add_argument("--smiles_file", default="./data/fruity.csv")
parser.add_argument("--model_path", default="./model/fruity_stat.pkl")
parser.add_argument("--proba_res", default="./data/fruity_res.csv")
